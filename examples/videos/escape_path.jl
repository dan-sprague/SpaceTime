...
const KEYS = [
    ...
    (0.62, SVector(25.0, 1.8, -2.6), SVector(0.0, 0.0, 0.0),   SVector(0.0, 1.0, 0.0),  50.0),
    (0.75, SVector(15.0, 1.2, -0.6), SVector(0.0, 0.0, 0.0),   SVector(0.0, 0.9, 0.2),  42.0),
    (0.83, SVector(12.5, 1.1, 0.3),  SVector(0.0, 0.0, 0.0),   SVector(0.0, 0.7, 0.6),  40.0),
